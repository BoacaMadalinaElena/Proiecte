            ...
            if (file.exists()) {
                try {
                    ...
                    while ((nextRecord = csvReader.readNext()) != null) {
                        LogsMessage logsMessage = new LogsMessage(null, nextRecord[0], nextRecord[1], nextRecord[2], nextRecord[3],"Feedback");
                    ...
                    CustomPrinter.printInfo("Response send logs: " +responseEntity.getStatusCode().toString());
