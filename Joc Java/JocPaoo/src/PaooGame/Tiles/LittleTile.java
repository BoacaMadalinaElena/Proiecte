...
/*! \class public class LittleTile extends Tile
 ...
 */
public class LittleTile extends Tile
{
    /*! \fn public LittleTileTile(int id)
       \brief Constructorul de initializare al clasei

       \param id : Nu este folosit(compatibilitate).
    */
    public LittleTile(int id)
    {
        super(Assets.little, id);
    }
