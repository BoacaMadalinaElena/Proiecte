...
#define  PANEL_2_GRAPH_WINDOW             13      /* control type: ring, callback function: functieDateSchimbate */
#define  PANEL_2_FILTER_TYPE              14      /* control type: ring, callback function: functieDateSchimbate */
#define  PANEL_2_NUMERIC_FPASS            15      /* control type: numeric, callback function: functieDateSchimbate */
#define  PANEL_2_NUMERIC_FSTOP            16      /* control type: numeric, callback function: functieDateSchimbate */
...
#define  PANEL_2_TOGGLEBUTTON             19      /* control type: textButton, callback function: functieDateSchimbate */
#define  PANEL_2_TIMER                    20      /* control type: timer, callback function: OnTimer */
#define  PANEL_2_RING_SECOND              21      /* control type: ring, callback function: functieDateSchimbate */
#define  PANEL_2_COMMANDBUTTON            22      /* control type: command, callback function: SaveFreq */
#define  PANEL_2_RING_TIP_AFISARE         23      /* control type: ring, callback function: functieDateSchimbate */
#define  PANEL_2_NUMERIC_ORDER            24      /* control type: numeric, callback function: functieDateSchimbate */
#define  PANEL_2_COMMANDBUTTON_2          25      /* control type: command, callback function: SaveWaveFrequency */
...
int  CVICALLBACK functieDateSchimbate(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
